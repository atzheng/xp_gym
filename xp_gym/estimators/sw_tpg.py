...
class SwitchbackTPGEstimator(Estimator):
    ...
    def update(self, env, env_params, design, state: SwitchbackTPGEstimatorState, obs: Observation):
        """
    ...
    def estimate(self, env, env_params, design, state: SwitchbackTPGEstimatorState):
        """
...
@struct.dataclass
class SimpleSwitchbackTPGEstimatorState(EstimatorState):
    """
    State for Switchback Truncated Policy Gradient Estimator.
...
@struct.dataclass
class SimpleSwitchbackTPGEstimator(Estimator):
    """
    Switchback Truncated Policy Gradient Estimator.
